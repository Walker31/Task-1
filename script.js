...
function isCollide(snake){
  ...
  for(let i= 1; i<snakeArray.length;i++)
  {
    if(snake[i].x==snake[0].x && snake[i].y==snake[0].y){
      c=c-1;
      lives.innerHTML="Remaining lives " +c;
      return c;
    }
...
function gameEngine(){
  ...
  //if you have eaten the food, increemnt the score and regenerate the food
...
function start(){
  ...
  var password = document.getElementById("size").value;
  debugger;
}
